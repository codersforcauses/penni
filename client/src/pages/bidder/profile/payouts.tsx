...
export default function Payouts() {
  return (
    <div className="flex min-h-screen flex-col bg-penni-background-light-mode">
      ...
      <div>
        <div className="mt-4 py-4 text-hb text-penni-text-regular-light-mode lineHeight-co ml-4" >
          Bank Details
        </div>
