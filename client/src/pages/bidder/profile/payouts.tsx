...
export default function Payouts() {
  return (
    <div className="flex min-h-screen flex-col bg-penni-background-input-light-mode">
      ...
      <div>
        <div className="py-4 text-[17px] font-normal text-black" style={{ marginLeft: '16px', lineHeight: '20.29px' }}>
          Bank Details
        </div>
        ...
        <div className="w-full p-4 mt-8 flex items-center justify-center border border-gray-200 rounded-md">
